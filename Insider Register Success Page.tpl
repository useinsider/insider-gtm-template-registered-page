...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Insider Register Success Page",
  "brand": {
    "id": "brand_dummy",
    "displayName": "",
  ...
  "description": "This template defines register success page.",
  "containerContexts": [
    "WEB"
  ]
}
...
insiderObject.page = {type: 'Register Success'};
...
Created on 11/20/2020, 3:03:39 PM
